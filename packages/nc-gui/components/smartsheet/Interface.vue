<template>
  <div class="h-full flex flex-row">
    ...
    <!-- Canvas -->
    <div class="canvas flex-1 bg-gray-50 p-1" @dragover.prevent @drop="onDrop">
      <grid-layout
    ...
    <div class="w-80 bg-white border-l border-gray-200 p-4">
      ...
      <div v-if="selectedComponent">
        <component :is="configPanelsRegistry[selectedComponent.type]" :component="selectedComponent" @update="updateComponent" />
      </div>
      <div v-else>
